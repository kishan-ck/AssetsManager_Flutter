...
class Localization extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US' : {
      ...
      "strong_password" : "ⓘ Password must contain at least one uppercase letter, one lowercase letter, one digit, and one special character.",
      "forgot_password_?" : "Forgot password ?",
      "or_continue_with" : "or continue with",
      "don't_have_an_account_? " : "Don't have an account ? ",
      "sign_up" : "Sign up",
      "create_account" : "Create Account",
      "please_fill_the_input_below_here" : "Please fill the input below here",
      "full_name" : "Full Name",
      ...
      "ⓘ_password_incorrect._please_re-check_your_password." : "ⓘ Password incorrect. Please re-check your password.",
      "already_have_an_account_? " : "Already have an account ? ",
      "sign_in" : "Sign in",
      "hello" : "Hello ",
      "here_you_can_search_global_assets" : "Here you can search global assets",
      ...
      "you_can_select_any_category_in_which_you_are_interested" : "You can select any category in which you are interested",
