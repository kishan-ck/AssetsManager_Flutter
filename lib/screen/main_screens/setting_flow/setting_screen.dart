                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text("Arfaz Chhapawala",style: AppTextStyle.appbarTitleText,),
                        Text("arfaz.coderkube@gmail.com",style: AppTextStyle.regularSubTitleText,),
                      ],
                    ),
                    Container(
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    return Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Image.asset(controller.menuList[index]['icon'], color: AppColor.blackColor,height: size.height(24),),
                        size.widthSpace(17),
                        Text(controller.menuList[index]['text'],style: AppTextStyle.regularSubTitleText,textAlign: TextAlign.center,),
                        const Spacer(),
                        Row(
                          children: [
                            index == 1 ? Text("English",style: AppTextStyle.regularSubTitleText.copyWith(color: AppColor.greyColor,),textAlign: TextAlign.center,) : const SizedBox(),
                            Icon(Icons.arrow_forward_ios_rounded, color: AppColor.blackColor, size: size.height(24),),
                          ],
                        )
                      ],
                    );
                  },
                    separatorBuilder: (context, index) => SizedBox(height: size.height(25),),
                  ),
                ),
                size.heightSpace(40),
                GestureDetector(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Image.asset(AppImagePath.logoutIcon, color: AppColor.redColor,height: size.height(24),),
                      size.widthSpace(17),
                      Text("Log Out",style: AppTextStyle.regularSubTitleText.copyWith(color: AppColor.redColor),textAlign: TextAlign.center,),
                    ],
                  ),
                ),
              ],
