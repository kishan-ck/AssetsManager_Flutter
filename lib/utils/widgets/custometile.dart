...
class ExpansionTileController {
  ...
  _ExpansionTileCustomeState? _state;
  ...
  static ExpansionTileController of(BuildContext context) {
    final _ExpansionTileCustomeState? result =
        context.findAncestorStateOfType<_ExpansionTileCustomeState>();
    if (result != null) {
  ...
  static ExpansionTileController? maybeOf(BuildContext context) {
    return context
        .findAncestorStateOfType<_ExpansionTileCustomeState>()
        ?._tileController;
  }
}
...
class ExpansionTileCustome extends StatefulWidget {
  ...
  @override
  State<ExpansionTileCustome> createState() => _ExpansionTileCustomeState();
}

class _ExpansionTileCustomeState extends State<ExpansionTileCustome>
  ...
  Widget _buildIcon(BuildContext context) {
    return RotationTransition(
      ...
      child: Icon(Icons.arrow_drop_down_outlined,
          color: widget.dropDownIconColor ?? AppColor.whiteColor, size: 34),
    );
  }
          ...
          GestureDetector(
            ...
            child: Semantics(
              ...
              child: ListTileTheme.merge(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(vertical: size.height(8.0)),
                  child: Row(
